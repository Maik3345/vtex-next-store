...
export const shopCartStyles = tv({
  slots: {
    ...
    contentWrapper:
      "flex flex-col justify-center transition-all h-full h-[200px]",
    title: [
      "relative",
      "w-full",
      "flex-none",
    ...
    starButton:
      "absolute top-3 right-3 text-default-400 data-[liked=true]:text-warning",
  ...
  variants: {
    theme: {
      nextui: {
        ...
        imageWrapper: [
          "before:rounded-2xl",
          "before:from-[#010187] before:to-[#18000E]",
        ],
        sizeOption: [
